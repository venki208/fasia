...
SESSION_COOKIE_DOMAIN = "test.fasiaamerica.org/auth"
...
DEFAULT_FASIA_DOMAIN_URL = 'https://test.fasiaamerica.org'
DEFAULT_DOMAIN_URL = 'https://test.fasiaamerica.org/auth/'
